...
open class ToastView: UIView {
  ...
  private let backgroundView: UIView = {
    let `self` = UIView()
    self.backgroundColor = UIColor.darkGray//.black//UIColor.black//COLOR.yellowColor//UIColor(white: 0, alpha: 0.7)
  ...
  private let textLabel: UILabel = {
    ...
    self.font = {
      switch UIDevice.current.userInterfaceIdiom {
      case .unspecified: return UIFont.systemFont(ofSize: 12)
      case .phone: return UIFont.systemFont(ofSize: 12)
